...
namespace UICatel.Shader
{
    public class NoiseEffect : ShaderEffect
    {
        ...
        public NoiseEffect()
        {
            ...
            pixelShader.UriSource = new Uri(@"C:\Users\aizik\Source\Repos\GoogleTranslate\UICatel\Shader\Noise.ps", UriKind.Absolute);
            PixelShader = pixelShader;
            BitmapImage bitmap = new BitmapImage();
            bitmap.BeginInit();
            bitmap.UriSource = new Uri(@"C:\Users\aizik\Source\Repos\GoogleTranslate\UICatel\Images\noise.png");
            bitmap.EndInit();
            RandomInput =
